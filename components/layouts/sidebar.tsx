...
import IconRoleApps from '../icon/menu/icon-role-app';
import IconSettingsApps from '../icon/menu/icon-settings-apps';
            ...
            >
                <div className="h-full bg-white dark:bg-black">
                    <div className="flex items-center justify-between px-4 py-3">
                        <Link href="/dashboard/admin" className="main-logo flex shrink-0 items-center">
                            <img className="ml-[5px] w-11-5 flex-none" src="/assets/images/ECALogo.svg" alt="logo" />
                            {/* <span className="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">ECA Boilers</span> */}
                        </Link>

                        <button
                            type="button"
                            className="collapse-icon flex h-8 w-15 items-center rounded-full transition duration-300 hover:bg-gray-500/10 rtl:rotate-180 dark:text-white-light dark:hover:bg-dark-light/10"
                    ...
                    <PerfectScrollbar className="relative h-[calc(100vh-80px)]">
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'dashboard' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href="/dashboard/admin">{t('admin')}</Link>
                                        </li>
                                        {/* <li>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'users' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <Link href="/admin/user-role">{t('user_role')}</Link>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <Link href="/admin/aduitlog" className="group">
                                    <div className="flex items-center">
                                        <IconMenuTables className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('audit_log')}</span>
                                    </div>
                                </Link>
                            </li>
                            ...
                            {/* <button type="button" className={`${currentMenu === 'settings' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('settings')}>
                                    <div className="flex items-center">
                                        <IconSettingsApps className="shrink-0 group-hover:!text-primary" />
                            ...
                            {/* <AnimateHeight duration={300} height={currentMenu === 'settings' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500"> */}
                            {/* <li>
                                            <Link href="/admin/settings/emailconfig">{t('email_config')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/admin/settings/permissions">{t('permissions')}</Link>
                                        </li> */}
                            {/* <li>
                                            <Link href="/admin/settings/country">{t('country')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/admin/settings/state">{t('state')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/admin/settings/city">{t('city')}</Link>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li> */}
                            ...
                            <h2 className="-mx-4 mb-1 flex items-center bg-white-light/30 px-7 py-3 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                <IconMinus className="hidden h-5 w-4 flex-none" />
                                <span>{t('vendor_employee')}</span>
                            </h2>
                            <li className="menu nav-item">
                                <Link href="/vendor" className="group">
                                    <div className="flex items-center">
                                        <IconEmployeeApps className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('vendor')}</span>
                                    </div>
                                </Link>
                            </li>
                            <li className="menu nav-item">
                                <Link href="/employee/role" className="group">
                                    <div className="flex items-center">
                                        <IconRoleApps className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('employee_role')}</span>
                                    </div>
                                </Link>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'Prodsettings' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('Prodsettings')}>
                                    <div className="flex items-center">
                                        <IconSettingsApps className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('settings')}</span>
                                    </div>

                                    <div className={currentMenu !== 'Prodsettings' ? '-rotate-90 rtl:rotate-90' : ''}>
                                        <IconCaretDown />
                                    </div>
                                </button>

                                <AnimateHeight duration={300} height={currentMenu === 'Prodsettings' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href="/product/settings/category">{t('category')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/product/settings/subcategory">{t('subcategory')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/product/settings/producttype">{t('product_type')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/product/settings/productenergy">{t('product_energy')}</Link>
                                        </li>
                                        <li>
                                            <Link href="/product/settings/troubleshoot">{t('Trouble Shoot')}</Link>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
